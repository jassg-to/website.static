...
<html lang="en">
    ...
    <body>
        ...
        <? if($envio == 1){?>
            <!-- Modal -->
            <div id="myModal" class="modal t-modal style_modal" role="dialog" style="display: block">
                <div class="modal-dialog">

                    <!-- Modal content-->
                    <div class="modal-content">
                        <div class="modal-header new_style_modal">
                            <button type="button" id="close" class="close" data-dismiss="modal">&times;</button>
                        </div>
                        <div class="modal-body alert text-center mt10">
                            <img src="images/correto_icn@2x.png" alt="" width="80px">
                            <p class="mt20 modal__title"><strong><?=$textos['obrigado']?></strong></p>
                            <p><?=$textos['mensagem_enviada']?></p>
                        </div>
                    </div>
            ...
            if($envio == 2){?>
                <!-- Modal -->
                <div id="myModal2" class="modal t-modal style_modal" role="dialog" style="display: block">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body alert text-center mt10">
                                <img src="images/erro_icn@2x.png" alt="" width="80px">
                                <p class="mt20 modal__title"><strong><?=$textos['ooops']?></strong></p>
                                <p><?=$textos['mensagem_nao_enviada']?></p>
                            </div>
                        </div>
            ...
            if($envio == 3){?>
                <!-- Modal -->
                <div id="myModal3" class="modal t-modal style_modal" role="dialog" style="display: block">
                    <div class="modal-dialog">
